...
console.log("📍 Dispatch Received:", routeData);

// Ensure keys match what sendTriageData is sending

if (drawRoute && routeData.user_location && routeData.coordinates) {

// Map component 'to' key = dispatchPayload 'coordinates' key

const missionRoute = [{

from: routeData.user_location,

to: routeData.coordinates

}];


console.log("🚑 Mission Confirmed. Dispatching 3D Ambulance...");

drawRoute(missionRoute);
...
// Replace with your key from developer.tomtom.com (No card required)

const TOMTOM_KEY = "kbUl1DknoaCi3oUtlXS2E5ctJJaRLYuP";
...
this.baseModel = null; // Store base model for dynamic cloning
...
// FIX: Dynamically create 3D model if it doesn't exist for this index
