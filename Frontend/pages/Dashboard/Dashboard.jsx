    ...
    return (
        <div className="bg-surface font-body text-on-surface selection:bg-secondary-fixed overflow-hidden h-screen flex flex-col">
            ...
            <main className="relative flex-1 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 map-container grayscale-[0.2]">
                    {/* Animated Map Elements */}
                    <div className="absolute top-[30%] left-[45%] flex items-center gap-2">
                        <div className="w-4 h-4 bg-secondary-fixed rounded-full shadow-[0_0_20px_#62fae3] animate-pulse"></div>
                        <div className="bg-primary/90 text-white px-2 py-1 rounded text-[0.6rem] font-bold">UNIT 104 - 4 min</div>
                    </div>
                    <div className="absolute top-[60%] left-[55%] flex items-center gap-2">
                        <div className="w-4 h-4 bg-error rounded-full shadow-[0_0_20px_#ba1a1a] animate-pulse"></div>
                        <div className="bg-primary/90 text-white px-2 py-1 rounded text-[0.6rem] font-bold">TRAUMA 1 - ACTIVE</div>
                    </div>
                </div>
